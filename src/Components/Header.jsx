...
import { FaUser, FaSignOutAlt, FaShoppingBag, FaInfoCircle, FaBars, FaTimes } from "react-icons/fa";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        } absolute top-full left-0 w-full bg-blue-100 md:static md:flex md:bg-transparent md:items-center md:w-auto`}
      >
        <div className="flex flex-col md:flex-row md:space-x-5 px-4 md:px-0">
          <NavLink
            to="/men"
            className={({ isActive }) =>
              isActive
        ...
        <div className="flex flex-col md:flex-row md:space-x-4 items-center px-4 md:px-0">
