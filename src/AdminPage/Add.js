...
//                 className="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:font-semibold file:bg-purple-50 file:text-blue-950 hover:file:bg-purple-100"
//                 required
//               />
//             </div>
//             <div className="mb-4">
...
//         <button
//           type="submit"
//           className="mt-6 w-full py-2 px-4 bg-blue-950 text-white rounded-md shadow"
//         >
//           Add Product
//         </button>
//       </form>
